export default {
  'menu.service.chatapp': 'Messaging service',
  'groupForm.title.video': 'Basic service information',
  'groupForm.title.audio': 'Service blacklist',
  'groupForm.title.description': 'Service remarks',
  ...
  'groupForm.submit': 'Start service',
  'groupForm.reset': 'Terminate service',
  'groupForm.submitSuccess': 'Started successfully',
};
